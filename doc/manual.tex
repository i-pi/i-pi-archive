...
As a concrete example, the default output would be generated with
...
are actually required to provide converged results.
As a last tutorial then, you should repeat tutorials 1 and 2 with
this number of replicas. The directory {}``tutorial 3'' contains a stub of
a NVT input file, which can be used to do a fully converged
NPT simulation.

If the simulation is run correctly
at this state point \cite{That Tuckermann paper}
