...
def get_np(fname, prefix, bsize, P, mamu, Tkelv, s, ns, cut):   
    ...
    if(ns == 0): ns = int(2*s*np.sqrt(T * P * m)+20)
...
if __name__ == '__main__':
    ...
    parser.add_argument( 'datafile', type=str, help = "name of the end-to-end distance vectors file")
    ...
    get_np(args.datafile, args.prefix, args.bsize, args.P, args.m, args.T,args.dint, args.ns, args.cut)
