...
class Properties(dobject):
   ...
   def __init__(self):
      ...
      "stress_md": {"dimension": "pressure", "help": "The classical stress tensor of the simulation. Takes arguments 'x' and 'v', which gives stress[x,v]. By default gives stress[0,0]."},
      "pressure_md": {"dimension": "pressure", "help": "The classical pressure of the simulation." },
      "kstress_md": {"dimension": "pressure", "help": "The classical kinetic stress tensor of the simulation. Takes arguments 'x' and 'v', which gives kstress[x,v]. By default gives kstress[0,0]." },
      "virial_md": {"dimension": "pressure", "help": "The classical virial tensor of the simulation. Takes arguments 'x' and 'v', which gives virial[x,v]. By default gives virial[0,0]."},
      "stress_cv": {"dimension": "pressure", "help": "The physical stress tensor of the system. Takes arguments 'x' and 'v', which gives stress[x,v]. By default gives stress[0,0]."},
      "pressure_cv": {"dimension": "pressure", "help": "The physical pressure of the system."},
      "kstress_cv": {"dimension": "pressure", "help": "The physical kinetic stress tensor of the system. Takes arguments 'x' and 'v', which gives kstress[x,v]. By default gives kstress[0,0]."},
      "virial_cv": {"dimension": "pressure", "help": "The physical virial tensor of the system. Takes arguments 'x' and 'v', which gives virial[x,v]. By default gives virial[0,0]."},
      "gle_ke": {"dimension": "energy", "help": "Gives the kinetic energy associated with the additional degrees of freedom used in the GLE thermostat. Takes an argument 'mode' which gives the degree of freedom that is looked at, and defaults to 0."},
      "kin_yama": {"dimension": "energy", "help": "Gives the Yamamoto kinetic energy estimator. Takes one argument, 'fd_delta', which gives the value of the finite difference parameter used. It defaults to " + str(-self._DEFAULT_FINDIFF) + "."},
